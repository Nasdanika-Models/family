...
public class ECoreGenFamilyProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenFamilyProcessorsFactory(requirement.requirement().context()))));
	}
