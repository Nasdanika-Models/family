 ...
 * @generated
 */
public class FamilyImpl extends DocumentedNamedElementImpl implements Family {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public EList<Person> getMembers() {
		return (EList<Person>)eDynamicGet(FamilyPackage.FAMILY__MEMBERS, FamilyPackage.Literals.FAMILY__MEMBERS, true, true);
	}
